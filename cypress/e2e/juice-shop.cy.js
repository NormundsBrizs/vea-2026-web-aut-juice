...
describe('Juice-shop scenarios', () => {
  ...
  context('With auto login', () => {
    ...
    it('Read a review', () => {
      ...
      HomePage.reviewsDropdown.click();
      // Validate review - K33p5 y0ur ju1cy 5plu773r 70 y0ur53lf!
      HomePage.reviews.should('be.visible').should('contain.text', 'K33p5 y0ur ju1cy 5plu773r 70 y0ur53lf!');
    });
    ...
    it('Add a review', () => {
      ...
      HomePage.reviewField.should('be.visible').type('Tastes like metal');
      // Click Submit
      HomePage.reviewSubmit.click();
      // Click expand reviews button/icon (wait for reviews to appear)
      HomePage.reviewsDropdown.click();
      // Validate review -  "Tastes like metal"
      HomePage.reviews.should('be.visible').should('contain.text', 'Tastes like metal');
    });
    ...
    it('Validate product card amount', () => {
      ...
      HomePage.itemsPerPageSelection.contains('24').click();
      // Validate that the amount of cards is 24
      HomePage.cards.should('have.length', 24);
      // Change items per page (at the bottom of page) to 36
      HomePage.itemsPerPageDropdown.click();
      HomePage.itemsPerPageSelection.contains('36').click();
    ...
    it('Buy Girlie T-shirt', () => {
      ...
      DeliveryMethodPage.selectDeliveryMethod('Standard Delivery');
      // Click Continue button
      DeliveryMethodPage.continueButton.click();
      // Create page object - PaymentOptionsPage
      // Select card that ends with "5678"
      PaymentOptionsPage.selectPaymentOption('5678');
      // Click Continue button
      ...
      OrderCompletionPage.completionText.should('have.text', 'Thank you for your purchase!');
    });
